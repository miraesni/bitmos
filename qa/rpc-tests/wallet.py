...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitmoscoin, node 1 has 4250bitmoscoin, node2 has none.
#   d) node0 sends 601 bitmoscoin to node2, in two transactions (301 bitmoscoin, then 300 bitmoscoin).
