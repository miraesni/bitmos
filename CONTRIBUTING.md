Contributing to BitmosCoin Core
============================

The BitmosCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitmosCoin Core project, and is not to be
confused with overall BitmosCoin Network Protocol consensus changes.

Whether a pull request is merged into BitmosCoin Core rests with the project merge
...
Patches that change BitmosCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitmosCoin consensus, it must have been
...
The project leader is the release manager for each BitmosCoin Core release.
