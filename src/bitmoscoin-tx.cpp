...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitmosCoin Core bitmoscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitmoscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BitmosCoin transaction") + "\n" +
                               "  bitmoscoin-tx [options] -create [commands]   " + _("Create hex-encoded BitmosCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BitmosCoin transaction
