...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitmosCoin Core"),
     ...
     * override -datadir in the bitmoscoin.conf file in the default data directory
     * (to be consistent with bitmoscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
