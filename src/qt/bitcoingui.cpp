...
QFontDatabase::addApplicationFont(":/fonts/bitmoscoin_font");

QString windowTitle = tr("BitmosCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitmosCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BitmosCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitmosCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitmosCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitmosCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitmosCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitmosCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BitmosCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BitmosCoin Core help message to get a list with possible BitmosCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitmosCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitmosCoin network", "", count));
}
...
{
    QString strTitle = tr("BitmosCoin Core"); // default title
