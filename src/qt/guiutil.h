...
/** Utility functions used by the BitmosCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BitmosCoin addresses in monospace font
...
// Parse "bitmoscoin:" URI into recipient object, return true on successful parsing
