/* src/config/bitmoscoin-config.h.  Generated from bitmoscoin-config.h.in by configure.  */
/* src/config/bitmoscoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BitmosCoin_CONFIG_H

#define BitmosCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bitmoscoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitmosCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitmosCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitmoscoin"
