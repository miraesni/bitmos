...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitmosCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitmosCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitmosCoin features */
        {"bitmoscoin", "masternode", &masternode, true, true, false},
        {"bitmoscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitmoscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitmoscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitmoscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitmoscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitmoscoin", "startmasternode", &startmasternode, true, true, false},
        {"bitmoscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitmoscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitmoscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitmoscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitmoscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitmoscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitmoscoin", "mnsync", &mnsync, true, true, false},
        {"bitmoscoin", "spork", &spork, true, true, false},
        {"bitmoscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitmoscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitmoscoind, or the -server option to bitmoscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitmoscoin-cli " + methodname + " " + args + "\n";
}
