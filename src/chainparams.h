 ...
 * BitmosCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& BitmosCoinDevKey() const { return vBitmosCoinDevKey; }
    // const std::vector<unsigned char>& BitmosCoinFundKey() const { return vBitmosCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vBitmosCoinDevKey;
    // std::vector<unsigned char> vBitmosCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
