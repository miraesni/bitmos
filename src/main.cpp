...
#if defined(NDEBUG)
#error "BitmosCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubitmoscoin) are considered zero fee (for relaying and mining)
...
{
    RenameThread("bitmoscoin-scriptch");
