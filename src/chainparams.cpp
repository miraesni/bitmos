...
public:
    CMainParams()
    {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0422e9f50126ceaeda2fe51dcc70bd0acd3d49e03701d8738800b4088a9b1fc41cc03c9cb4c7b4015f55ebfb477f6a930ba77cb177355165b1e8067971c00a56b8") << OP_CHECKSIG;
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("bitmoscoin.net", "seed01.bitmoscoin.net"));     // Primary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet BitmosCoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet BitmosCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet BitmosCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitmosCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitmosCoin BIP44 coin type is '1' (All coin's testnet default)
