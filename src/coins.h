...
/**
    ...
    ****Note - for BitmosCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of BitmosCoin coming in to a transaction
