...
In order to support loading of multiple wallets in bitmoscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitmoscoin.cpp.
...
Changes to bitmoscoin.cpp
----------------------
bitmoscoin.cpp is the entry point into bitmoscoin-qt, and as such, will require some minor modifications to provide hooks for
