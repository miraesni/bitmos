...
* WebSocket: [https://github.com/BitmosCoin-Core/insight-api-bitmoscoin#web-socket-api](https://github.com/BitmosCoin-Core/insight-api-bitmoscoin#web-socket-api)
* API: [https://github.com/BitmosCoin-Core/insight-api-bitmoscoin#swifttx-transactions](https://github.com/BitmosCoin-Core/insight-api-bitmoscoin#swifttx-transactions)
...
By default, the BitmosCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitmosCoin Core daemon:
